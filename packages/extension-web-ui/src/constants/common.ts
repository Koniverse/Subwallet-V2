...
export const TELEGRAM_URL = 'https://t.me/availspaceapp';
export const TWITTER_URL = 'https://twitter.com/availspaceapp';
export const DISCORD_URL = 'https://discord.gg/JuBCJKYdjG';
export const SUPPORT_MAIL = 'mailto:agent@availspace.app';
