...
import { _isAssetHubChain, _isChainSupportEvmERC20, _isChainSupportVFT, _isChainSupportWasmPSP22 } from '@subwallet/extension-base/services/chain-service/utils';
