...
export interface ConfirmationDefinitions {
  ...
  evmSignAuthorizationRequest: [ConfirmationsQueueItem<SignAuthorizeRequest>, ConfirmationResult<string>]
}
