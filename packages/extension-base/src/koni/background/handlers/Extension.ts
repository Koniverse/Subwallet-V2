...
export default class KoniExtension {
  ...
  private async evmDelegate7702 (request: RequestAccountDelegateEIP7702): Promise<SWTransactionResponse> {
    ...
    return await this.#koniState.transactionService.handleTransaction({
      ...
      data: { ...request, delegateAddress: delegatee },
      extrinsicType: ExtrinsicType.EIP7702_DELEGATE,
      chainType: ChainType.EVM
    });
  }

  private async evmUnDelegate7702 (request: RequestAccountUnDelegateEIP7702): Promise<SWTransactionResponse> {
    ...
    const delegatee = ZeroAddress as HexString;
    ...
    const authParams: SignAuthEIP7702 = {
      address,
      chain,
      delegateType: EIP7702DelegateType.REMOVE,
      chainId,
      nonce: nonce,
      contractAddress: delegatee
    };
  ...
  private async handleTransactionWith7702 (request: RequestHandleTransactionWith7702): Promise<SWTransactionResponse> {
    ...
    return this.#koniState.transactionService.handleEIP7702Transaction({
      address,
      chain,
      transaction: {
  ...
  private async handleEIP7683Request (request: RequestEIP7683): Promise<SWTransactionResponse> {
    return this.#koniState.handleEIP7683Request(request);
  }
  ...
  public async handle<TMessageType extends MessageTypes> (id: string, type: TMessageType, request: RequestTypes[TMessageType], port: chrome.runtime.Port): Promise<ResponseType<TMessageType>> {
    ...
    switch (type) {
      ...
      case 'pri(accounts.evm.eip7702.undelegate)':
        return this.evmUnDelegate7702(request as RequestAccountUnDelegateEIP7702);
      case 'pri(accounts.evm.eip7702.handle)':
        return this.handleTransactionWith7702(request as RequestHandleTransactionWith7702);
      case 'pri(accounts.evm.eip7683.handle)':
        return this.handleEIP7683Request(request as RequestEIP7683);
