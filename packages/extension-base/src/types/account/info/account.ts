...
import { AAProvider, AAProviderConfig } from './account-abstraction';
 ...
 */
export interface AccountMetadataData extends AccountExternalData, AccountLedgerData, AccountInjectData, AccountDeriveData, SmartAccountData {}
 ...
 * @prop {string[]} specialChains - List chains, which account can only be used on, if not provided, account can be used on all chains
