...
import { _generateCustomProviderKey, _getChainNativeTokenBasicInfo, _isChainEvmCompatible, _isCustomProvider, _isChainSubstrateCompatible } from '@subwallet/extension-base/services/chain-service/utils';
