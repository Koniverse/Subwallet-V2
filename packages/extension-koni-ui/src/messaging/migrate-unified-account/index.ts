...
import { RequestMigrateSoloAccount, RequestMigrateUnifiedAccount, RequestRequiredMigrateAccountStatus, ResponseIsShowMigrationAccount, ResponseMigrateSoloAccount, ResponseMigrateUnifiedAccount } from '@subwallet/extension-base/background/KoniTypes';
