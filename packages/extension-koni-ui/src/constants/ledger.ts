...
export const BLOCK_TRANSFER_XCM_LEDGER_NETWORKS: string[] = ['acala', 'aleph', 'alephTest', 'astar', 'avail_mainnet', 'karura', 'edgeware', 'xx_network', 'polymesh', 'polkadex', 'ethereum'];
