...
import { useGoBackSelectAccount } from '@subwallet/extension-koni-ui/hooks';
...
const Component: React.FC<Props> = ({ address, className, id: modalId }: Props) => {
  ...
  return (
    ...
    >
      <div className='simple-qr-code-wrapper'>
        <SwQRCode
          color='#000'
          errorLevel='H'
      ...
      <div className={'simple-account-item-wrapper'}>
        <AccountItem
          address={address || ''}
          addressPreLength={7}
          addressSufLength={7}
